export default function ExploreBuildings({ data }) {
  const d = data || {};
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {buildings.map((b, i) => (
            <div
              key={i}
              className="rounded-xl overflow-hidden bg-white/10 backdrop-blur-sm hover:-translate-y-2 hover:shadow-2xl transition-all duration-300"
            >
              ...
              <div className="p-5 text-center">
                <h4 className="font-sans font-semibold text-base mb-2">
                  {b.name}
                </h4>
                <div className="flex justify-center gap-2 flex-wrap">
                  ...
                  {b.badge && (
                    <span className="inline-block px-4 py-1 rounded-full text-xs font-semibold bg-green-500 text-white">
                      {b.badge}
                    </span>
                  )}
                </div>
