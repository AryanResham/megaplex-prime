export default function AboutProject({ data, highlightField }) {
  const d = data || {};
  ...
  return (
    <section id="about" className="bg-gradient-to-br from-blue-50 to-green-50 py-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        {/* Content */}
        <div>
          <h2 className={` text-3xl md:text-4xl font-bold text-gray-900 mb-6 ${hl('title')}`}>
            {d.title || 'About Project'}
          </h2>
          <p className={`text-gray-600 leading-relaxed mb-4 text-[15px] ${hl('description')}`}>
          ...
          <p className={`text-gray-600 leading-relaxed mb-6 text-[15px] ${hl('description2')}`}>
          ...
          <button className={`bg-green-600 hover:bg-transparent text-white hover:text-green-600 border-2 border-green-600 px-8 py-3.5 rounded-full font-semibold transition-all duration-300 ${hl('buttonText')}`}>
